...
sports = [[MLB,"MLB",False], [NFL,"NFL",False], [NBA,"NBA",False], [NHL,"NHL",False], [NCAAF,"NCAAF",True], [NCAAM,"NCAAM",True]]
        ...
        if inSeason(data) is True:
            ...
            for game in data['events']:
                ...
                if getSeasonType(data) == "Regular Season":
                    ...
                    print(
                        displayAwayRecord + " " + displayAwayTeam + " (" + displayAwayScore + ") @ " + displayHomeRecord + " " + displayHomeTeam + " (" + displayHomeScore + ") - " + displayGameStatus, end=" ")
                #Determine if Postseason to display recoed
                    ...
                    #Print Results
                    print(displayAwayTeam + " (" + displayAwayScore +") @ " + displayHomeTeam + " (" + displayHomeScore +") - " + displayGameStatus, end=" ")
